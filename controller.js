...
// function to configure a slider
function configureSlider(id, variable, min, max) {
  var slider = document.getElementById(id);

  slider.addEventListener("input", function () {
    effects[variable].value = scaleValue(this.value, 0, 100, min, max);
    updateEffects();
  });
}

// configure all the effect sliders
configureSlider("sliderReverb", "reverb", 0, 1);
configureSlider("sliderDelay", "delay", 0, 1);
configureSlider("sliderPhaser", "phaser", 0, 1);
configureSlider("sliderChorus", "chorus", 0, 1);
...
// // define the effects
// var effects = [
//   { id: "reverb", effect: reverbEffect },
//   { id: "delay", effect: delayEffect },
//   { id: "phaser", effect: phaserEffect },
//   { id: "chorus", effect: chorusEffect },
// ];
